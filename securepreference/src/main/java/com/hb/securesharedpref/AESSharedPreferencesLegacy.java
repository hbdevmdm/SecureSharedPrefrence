...
import com.hb.securesharedpref.utility.SecurePreferencesLegacy;

import java.util.ArrayList;
import java.util.List;
import java.util.Set;

class AESSharedPreferencesLegacy implements PreferenceProvider {

    private SharedPreferences sharedPreferences;

    AESSharedPreferencesLegacy(Context context,String sharedPreferenceName) {
        if (context != null){
            sharedPreferences = new SecurePreferencesLegacy(context, "", sharedPreferenceName);
            SecurePreferencesLegacy.setLoggingEnabled(true);
        }
    }
