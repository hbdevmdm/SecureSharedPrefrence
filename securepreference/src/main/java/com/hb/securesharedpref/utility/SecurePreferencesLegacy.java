 ...
 */
package com.hb.securesharedpref.utility;
...
public class SecurePreferencesLegacy implements SharedPreferences {
    ...
    private static final String TAG = SecurePreferencesLegacy.class.getName();
     ...
     */
    public SecurePreferencesLegacy(Context context) {
        this(context, "", null);
    }
     ...
     */
    public SecurePreferencesLegacy(Context context, String salt) {
     ...
     */
    public SecurePreferencesLegacy(Context context, int iterationCount) {
     ...
     */
    public SecurePreferencesLegacy(Context context, final String password, final String sharedPrefFilename) {
     ...
     * @param iterationCount The iteration count for the keys generation
     */
    public SecurePreferencesLegacy(Context context, final String password, final String sharedPrefFilename, int iterationCount) {
     ...
     * @param sharedPrefFilename name of the shared pref file. If null use the default shared prefs
     */
    public SecurePreferencesLegacy(Context context, final AesCbcWithIntegrity.SecretKeys secretKey, final String sharedPrefFilename) {
     ...
     * @param iterationCount The iteration count for the keys generation
     */
    public SecurePreferencesLegacy(Context context, final String password, final String salt, final String sharedPrefFilename, int iterationCount) {
        this(context, null, password, salt, sharedPrefFilename, iterationCount);
    }

    private SecurePreferencesLegacy(Context context, final AesCbcWithIntegrity.SecretKeys secretKey, final String password, final String salt, final String sharedPrefFilename, int iterationCount) {
    ...
    public String getString(String key, String defaultValue) {
        final String encryptedValue = sharedPreferences.getString(
                SecurePreferencesLegacy.hashPrefKey(key), null);
    ...
    public boolean contains(String key) {
        return sharedPreferences.contains(SecurePreferencesLegacy.hashPrefKey(key));
    }
     ...
     * <p>
     * Used for modifying values in a {@link SecurePreferencesLegacy} object. All
     * changes you make in an editor are batched, and not copied back to the
     * original {@link SecurePreferencesLegacy} until you call {@link #commit()} or
     * {@link #apply()}.
     */
    public final class Editor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putString(String key, String value) {
            mEditor.putString(SecurePreferencesLegacy.hashPrefKey(key),
                    encrypt(value));
            return this;
        }
        ...
        public SharedPreferences.Editor putUnencryptedString(String key,
                                                             String value) {
            mEditor.putString(SecurePreferencesLegacy.hashPrefKey(key), value);
            return this;
        }
        ...
        public SharedPreferences.Editor putStringSet(String key,
            ...
            mEditor.putStringSet(SecurePreferencesLegacy.hashPrefKey(key),
                    encryptedValues);
            return this;
        }
        ...
        public SharedPreferences.Editor remove(String key) {
            mEditor.remove(SecurePreferencesLegacy.hashPrefKey(key));
            return this;
        }
